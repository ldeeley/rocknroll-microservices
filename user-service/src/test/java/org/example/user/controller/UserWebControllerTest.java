...
class UserWebControllerTest {
    ...
    void newUserForm() throws Exception {
            ...
            this.mockMvc
                    ...
                    .andExpect(view().name("/user_ThymeLeafTemplates/new_user"))
    ...
    void newUserFormPost() throws Exception {
        ...
        this.mockMvc
                .perform(MockMvcRequestBuilders.post("/user/newUserForm")
                        .param("name", "duke")
    ...
    void checkPageOfUsers() throws Exception {
        ...
        this.mockMvc
                ...
                .andExpect(MockMvcResultMatchers.view().name("/user_ThymeLeafTemplates/user_list"));
